                    ...
                    <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                        <div>
                            ...
                            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                                Here are all the great cocktail recipes you should know how to make,
                                from the margarita to the whiskey sour. Cheers!{" "}
                            </p>
                        </div>
                        <div>
                            <svg
                            ...
                            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                                ...
                                ... Moreover, enhancing the durability of individual hardware
                                components{" "}
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                                {" "}
                                They re-use, recycle and reduce waste disposal in their lives. They
                        ...
                        <div>
                            ...
                            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                                Minimalist interior design is very similar to modern interior design
                                and involves using the bare essentials{" "}
                            </p>
                        </div>
                    </div>
                </div> */}
